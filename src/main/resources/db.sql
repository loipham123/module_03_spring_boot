    ...
    UPDATE employee SET email = 'hoang.hai@gmail.com' WHERE name = 'Hoàng Văn Hải';
    UPDATE employee SET email = 'tran.hoai@gmail.com' WHERE name = 'Trần Thị Hoài';
    UPDATE employee SET email = 'le.van.sy@gmail.com' WHERE name = 'Lê Văn Sỹ';
    UPDATE employee SET email = 'pham.khanh@gmail.com' WHERE name = 'Phạm Duy Khánh';
    UPDATE employee SET email = 'hoang.quy@gmail.com' WHERE name = 'Hoàng Văn Quý';
